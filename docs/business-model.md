# Business Model: Repair of Transport Equipment, Except Motor Vehicles
...
## Classification
- Repository: `cloud-itonami-isic-3315` ([github.com/cloud-itonami/cloud-itonami-isic-3315](https://github.com/cloud-itonami/cloud-itonami-isic-3315))
- ISIC Rev.5: `3315` — Repair of Transport Equipment, Except Motor Vehicles
- Domain: `:manufacturing/transport-equipment-repair`
- Social impact: :worker-safety :repair-access :circular-economy-repair-over-replace
- Actor: `:transport-equipment-repair-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :manufacturing/transport-equipment-repair — who wants
...
Capability stack (required): :identity :forms :audit-ledger.
...
One managed tenant (:manufacturing/transport-equipment-repair):
...
- Do not bypass the `:transport-equipment-repair-governor` for production decisions.

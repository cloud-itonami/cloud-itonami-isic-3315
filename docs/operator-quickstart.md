# Operator Quickstart — Repair of Transport Equipment, Except Motor Vehicles

Shortest path from clone to a verified local dry-run for **ISIC 3315** (`cloud-itonami-isic-3315`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3315.git
cd cloud-itonami-isic-3315
```
...
- Blueprint governor key: `transport-equipment-repair-governor`
- Likely source path: `transport_equipment_repair.governor.cljc`
